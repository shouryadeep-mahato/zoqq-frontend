...
function Details({ setCurrentState }) {
    return (
        <div>
            ...
            <div className='d-flex'>
                <div className='d-flex border-bottom mb-4 w-50 me-2'>
                    ...
                    <div className="input-group containertext w-100 h-100">
                        <CustomTextField label="Request Number" className="w-100" />
                    </div>
                </div>
                ...
                <div className='d-flex border-bottom mb-4 w-50 ms-2'>
                    ...
                    <div className="input-group containertext w-100 h-100">
                        ...
                        <CustomTextField className="w-75" />
                    </div>
                </div>
            </div>
            ...
            <div className='my-4'>
                <CustomTextField className="w-100 border-bottom" label="Description (Optional)" />
            </div>
